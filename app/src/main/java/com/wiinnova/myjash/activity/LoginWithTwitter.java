...
public class LoginWithTwitter extends Activity {
    // Constants
    /**
...
//            alert.showAlertDialog(LoginWithTwitter.this, "Internet Connection Error",
//                    "Please connect to working Internet connection", false);
        ...
        if (TWITTER_CONSUMER_KEY.trim().length() == 0 || TWITTER_CONSUMER_SECRET.trim().length() == 0) {
            // Internet Connection is not present
//            alert.showAlertDialog(LoginWithTwitter.this, "Twitter oAuth tokens", "Please set your twitter oauth tokens first!", false);
            // stop executing code by return
            return;
        }
        ...
        if (!isTwitterLoggedInAlready()) {
            ...
            if (uri != null && uri.toString().startsWith(TWITTER_CALLBACK_URL)) {
                ...
                try {
                    ...
                    Log.d("isTwitterLoggedInAlr", username + " f");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("onActivityResult",requestCode+" and "+data);
    }
    ...
    class updateTwitterStatus extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(LoginWithTwitter.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                Log.d("StatusTwitter", "> " + response.getText());
            } catch (TwitterException e) {
